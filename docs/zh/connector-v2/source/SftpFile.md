...
| password                     | String  | 否    | -                   | 目标sftp密码                                                                                                                                                                                                                                           |
| identity_file_content_base64 | String  | 否    | -                   | 目标sft私钥base64内容，`password`或`identity_file_content_base64`须选择一个配置。                                                                                                                                                                                  |
| identity_file_pass           | String  | 否    | -                   | 目标sftp私钥密码                                                                                                                                                                                                                                         |
| path                         | String  | 是    | -                   | 源文件路径。                                                                                                                                                                                                                                             |
