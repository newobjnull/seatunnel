...
| port                                  | int     | yes      | -                                          |                                                                                                                                                                        |
| user                                  | string  | yes      | -                                          |                                                                                                                                                                        |
| password                              | String  | No       | -                                          | The target sftp password                                                                                                                                               |
| identity_file_content_base64          | String  | No       | -                                          | The target sftp identity file's content encoded by base64. `password` or `identity_file_content_base64` choose one and only one to set.                                |
| identity_file_pass                    | String  | No       | -                                          | The target sftp identity file's passphrase                                                                                                                             |
| path                                  | string  | yes      | -                                          |                                                                                                                                                                        |
