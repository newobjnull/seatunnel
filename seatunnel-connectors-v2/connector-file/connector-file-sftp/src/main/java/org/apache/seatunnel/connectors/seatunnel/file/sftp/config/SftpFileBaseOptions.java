...
public class SftpFileBaseOptions extends FileBaseOptions {
    ...
    public static final Option<String> SFTP_KEYFILE_CONTENT_BASE64 =
            Options.key("keyfile_content_base64")
                    .stringType()
                    .noDefaultValue()
                    .withDescription("SFTP server keyfile content base64");
    public static final Option<String> SFTP_KEYFILE_PASSPHRASE =
            Options.key("keyfile_passphrase")
                    .stringType()
                    .noDefaultValue()
                    .withDescription("SFTP server keyfile passphrase");
}
