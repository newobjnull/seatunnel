...
public class SFTPFileSystem extends FileSystem {
    ...
    public static final String FS_SFTP_IDENTITY_FILE_CONTENT_PREFIX =
            "fs.sftp.identity_file_content.";
    public static final String FS_SFTP_IDENTITY_FILE_PASS_PREFIX = "fs.sftp.identity_file_pass.";
    ...
    private ChannelSftp connect() throws IOException {
        ...
        String identityFileContent =
                conf.get(FS_SFTP_IDENTITY_FILE_CONTENT_PREFIX + host + "." + user, null);
        String identityFilePass =
                conf.get(FS_SFTP_IDENTITY_FILE_PASS_PREFIX + host + "." + user, null);

        ChannelSftp channel =
                connectionPool.connect(
                        host, port, user, pwd, identityFileContent, identityFilePass);
